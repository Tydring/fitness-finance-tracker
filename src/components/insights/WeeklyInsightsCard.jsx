import { Dumbbell, Wallet, Sparkles, Lightbulb, TrendingUp } from 'lucide-react';
...
function InsightSection({ icon: Icon, title, accentClass, section }) {
    ...
    return (
        <div className="insight-section">
            ...
            {section.summary && (
                <p className="insight-summary">{section.summary}</p>
            )}
        ...
        <div className="weekly-insights glass-card">
            <div className="insights-card-header">
                ...
                <div className="insights-card-meta">
                    <span className="insights-week-key">{formatWeekKey(insights.week_key)}</span>
